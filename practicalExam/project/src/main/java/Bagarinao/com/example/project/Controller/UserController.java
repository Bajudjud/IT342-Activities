package Bagarinao.com.example.project.Controller;
...
import Bagarinao.com.example.project.Service.ContactService;
...
public class UserController {
    ...
    @PostMapping("/add")
    public String addContact(@AuthenticationPrincipal OAuth2User user, @RequestParam String name, @RequestParam String email, @RequestParam(required = false) String phone, Model model) {
        if (user == null) {
